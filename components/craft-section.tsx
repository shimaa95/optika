      ...
      <div className="sticky top-0 flex min-h-dvh w-full flex-col items-center justify-center px-[var(--reel-gutter-x)]">
        <div className="reel-stage-copy reel-stage-copy--center relative z-20 w-full max-w-2xl">
          <div className="mb-[var(--space-5)]">
            <span
              className="gs-scene-2-title gs-dynamic-text-light xl:mb-8 mb-4 font-playfair xl:text-[20px] text-[16px] font-medium uppercase leading-[1.36] tracking-[0.11em]"
              style={{
                color: "#1a1a2e",
              }}
            >
          ...
          <h2
            className="gs-scene-2-title gs-dynamic-text mb-4 xl:mb-8 font-inter xl:text-[64px] lg:text-[48px] text-[32px] font-bold uppercase leading-[0.98] tracking-[-0.04em]"
            style={{
              maxWidth: "20ch",
              color: "#1a1a2e",
            }}
          ...
          <p
            className="gs-scene-2-p gs-dynamic-text-light mb-16 max-w-lg font-inter xl:text-[20px] text-[16px] font-medium leading-[1.5] tracking-[0.02em]"
            style={{ color: "#1a1a2e" }}
          >
