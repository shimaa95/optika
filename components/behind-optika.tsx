  ...
  return (
    <section className="w-full bg-[#F3F3F3] px-6 py-16 md:py-24 lg:px-26 2xl:px-50 lg:py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border border-black/10 w-full">
        {/* Top Left - Text */}
        <div className="flex flex-col justify-center p-8 md:p-12 lg:p-20 2xl:p-32 border-b md:border-b border-black/10 md:border-r">
          <div className="flex max-w-[480px] gap-5">
            <div className="w-[1px] shrink-0 self-stretch bg-black" />
            <div className="flex-1">
              <div className="mb-6 md:mb-8 text-[13px] md:text-[14px] leading-snug font-medium text-black">
                About<br />Us
              </div>
        ...
        {/* Top Right - Image */}
        <div className="relative flex flex-col items-center justify-center p-8 md:p-12 lg:p-20 2xl:p-24 border-b border-black/10">
          <div className="w-2 h-2 md:w-2.5 md:h-2.5 bg-[#E32626] rounded-full mb-6 md:mb-8" />
        ...
        {/* Bottom Left - Image */}
        <div className="relative p-8 md:p-12 lg:p-20 2xl:p-24 border-b md:border-b-0 md:border-r border-black/10">
          <div className="relative w-full aspect-[4/5] sm:aspect-square md:aspect-square">
            <Image 
        ...
        {/* Bottom Right - Text */}
        <div className="flex flex-col justify-center p-8 md:p-12 lg:p-20 2xl:p-32">
          <div className="flex max-w-[480px] gap-5">
            <div className="w-[1px] shrink-0 self-stretch bg-black" />
            <div className="flex-1">
              <div className="mb-6 md:mb-8 text-[13px] md:text-[14px] leading-snug font-medium text-black">
              ...
              <p className="mb-6 md:mb-8 text-[14px] md:text-[15px] lg:text-[16px] leading-relaxed text-black/90">
